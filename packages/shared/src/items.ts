...
export const ITEM_DEFS: Record<number, ItemDefinition> = {
  ...
  [makeItemId(3, 0, 1)]: {
    ...
    ringStats: { speedBonus: 3, damageBonus: 2, hpRegenBonus: 0.1, maxHpBonus: 5, maxManaBonus: 5 },
  },
  [makeItemId(3, 0, 2)]: {
    ...
    ringStats: { speedBonus: 12, damageBonus: 9, hpRegenBonus: 0.3, maxHpBonus: 22, maxManaBonus: 22 },
  },
  [makeItemId(3, 0, 3)]: {
    id: 303, name: "Emerald Ring", category: 3, subtype: 0, tier: 3,
    color: 0x44cc66, tierColor: TIER_COLORS[3],
    description: "Emerald pulses with natural power.",
    ringStats: { speedBonus: 21, damageBonus: 16, hpRegenBonus: 0.5, maxHpBonus: 40, maxManaBonus: 40 },
  },
  [makeItemId(3, 0, 4)]: {
    ...
    ringStats: { speedBonus: 30, damageBonus: 23, hpRegenBonus: 0.8, maxHpBonus: 57, maxManaBonus: 57 },
  },
  [makeItemId(3, 0, 5)]: {
    ...
    ringStats: { speedBonus: 39, damageBonus: 30, hpRegenBonus: 1.0, maxHpBonus: 75, maxManaBonus: 75 },
  },
  [makeItemId(3, 0, 6)]: {
    id: 306, name: "Celestial Ring", category: 3, subtype: 0, tier: 6,
    color: 0xffdd00, tierColor: TIER_COLORS[6],
    description: "A fragment of a fallen star.",
    ringStats: { speedBonus: 48, damageBonus: 37, hpRegenBonus: 1.3, maxHpBonus: 92, maxManaBonus: 92 },
  },
  [makeItemId(3, 0, 7)]: {
    id: 3007, name: "Infernal Band", category: 3, subtype: 0, tier: 7,
    color: 0xff4444, tierColor: TIER_COLORS[7],
    description: "A ring that burns with hellfire.",
    ringStats: { speedBonus: 58, damageBonus: 44, hpRegenBonus: 1.5, maxHpBonus: 110, maxManaBonus: 110 },
  },
  ...
  [makeItemId(2, 0, 13)]: {
    ...
    armorStats: { maxHpBonus: 0, manaRegenBonus: 0.8 },
  },
  [makeItemId(3, 0, 13)]: {
