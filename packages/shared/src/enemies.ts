...
import type { BossPhaseConfig } from "./types";
...
// --- Data-Driven Boss Phase Configs ---
// Each boss has 3 phases keyed by EnemyType. Phases are ordered 1→2→3.
// hpThreshold: enter phase when HP ratio drops to or below this value.

export const BOSS_PHASES: Record<number, BossPhaseConfig[]> = {
  // ===== MOLTEN WYRM (Infernal Pit) — Aggressive melee bruiser =====
  [EnemyType.MoltenWyrm]: [
    {
      // Phase 1 (100%-60%): Slow orbit, alternating spread and ring
      hpThreshold: 1.0,
      shootingPatterns: [ShootingPatternType.Spread3, ShootingPatternType.BurstRing8],
      shootCooldown: 1200,
      projectileDamage: 80,
      projectileSpeed: 120,
      projectileRange: 280,
      speed: 55,
      movementType: BossMovementType.Orbit,
      movementParam: 40, // orbit radius
      ability: BossAbilityType.None,
    },
    {
      // Phase 2 (60%-30%): Charge-and-retreat with lava pools
      hpThreshold: 0.6,
      shootingPatterns: [ShootingPatternType.Spread5, ShootingPatternType.Spiral5],
      shootCooldown: 800,
      projectileDamage: 120,
      projectileSpeed: 140,
      projectileRange: 300,
      speed: 100,
      movementType: BossMovementType.Charge,
      movementParam: 1500, // charge duration ms
      ability: BossAbilityType.AreaDenial,
      abilityCooldown: 6000,
      abilityParam: 60, // pool radius
    },
    {
      // Phase 3 (<30%): Meltdown — enrage bursts with devastating patterns
      hpThreshold: 0.3,
      shootingPatterns: [ShootingPatternType.RotatingCross, ShootingPatternType.MultiSpeedRing, ShootingPatternType.CounterSpiralDouble],
      shootCooldown: 500,
      projectileDamage: 160,
      projectileSpeed: 150,
      projectileRange: 350,
      speed: 110,
      movementType: BossMovementType.Chase,
      ability: BossAbilityType.Enrage,
      abilityCooldown: 10000,
      abilityParam: 3000, // enrage duration ms
    },
  ],

  // ===== THE ARCHITECT (Void Sanctum) — Spellcaster controller =====
  [EnemyType.TheArchitect]: [
    {
      // Phase 1 (100%-66%): Stationary spellcaster, spiral + spread
      hpThreshold: 1.0,
      shootingPatterns: [ShootingPatternType.Spiral8, ShootingPatternType.Spread5],
      shootCooldown: 900,
      projectileDamage: 110,
      projectileSpeed: 120,
      projectileRange: 550,
      speed: 0,
      movementType: BossMovementType.Stationary,
      ability: BossAbilityType.None,
    },
    {
      // Phase 2 (66%-33%): Teleports, summons void minions
      hpThreshold: 0.66,
      shootingPatterns: [ShootingPatternType.CounterSpiralDouble, ShootingPatternType.Spread5, ShootingPatternType.BurstRing12],
      shootCooldown: 650,
      projectileDamage: 160,
      projectileSpeed: 130,
      projectileRange: 550,
      speed: 40,
      movementType: BossMovementType.Teleport,
      movementParam: 4000, // teleport interval ms
      ability: BossAbilityType.SummonAdds,
      abilityCooldown: 20000,
      abilityParam: 2, // number of minions
      abilityMinionType: EnemyType.VoidMinion,
    },
    {
      // Phase 3 (<33%): Chaos — dense patterns, pulls players in, shield bursts
      hpThreshold: 0.33,
      shootingPatterns: [ShootingPatternType.MultiSpeedRing, ShootingPatternType.RotatingCross, ShootingPatternType.BurstRing16],
      shootCooldown: 450,
      projectileDamage: 200,
      projectileSpeed: 140,
      projectileRange: 550,
      speed: 50,
      movementType: BossMovementType.Teleport,
      movementParam: 3000, // faster teleports
      ability: BossAbilityType.PullPlayers,
      abilityCooldown: 8000,
      abilityParam: 200, // pull radius
    },
  ],

  // ===== JUNGLE WARDEN (Deep Jungle) — Trapper / nature tank =====
  [EnemyType.JungleWarden]: [
    {
      // Phase 1 (100%-66%): Stationary turret, light spread
      hpThreshold: 1.0,
      shootingPatterns: [ShootingPatternType.Spread3],
      shootCooldown: 1400,
      projectileDamage: 40,
      projectileSpeed: 120,
      projectileRange: 300,
    ...
    {
      // Phase 2 (66%-33%): Patrols room, vine snares players
      hpThreshold: 0.66,
      shootingPatterns: [ShootingPatternType.BurstRing8, ShootingPatternType.Spread5],
      shootCooldown: 1000,
      projectileDamage: 55,
      projectileSpeed: 130,
      projectileRange: 350,
      speed: 50,
      movementType: BossMovementType.Patrol,
      movementParam: 3000, // time at each waypoint ms
      ability: BossAbilityType.None,
    },
    {
      // Phase 3 (<33%): Chases aggressively, summons jungle vipers
      hpThreshold: 0.33,
      shootingPatterns: [ShootingPatternType.Spiral5, ShootingPatternType.BurstRing12],
      shootCooldown: 800,
      projectileDamage: 70,
      projectileSpeed: 140,
      projectileRange: 350,
      ...
      abilityParam: 3, // number of minions
      abilityMinionType: EnemyType.JungleViper,
    },
  ],
};
